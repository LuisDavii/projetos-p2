...
public class App {
        ...
        public static void main(String[] args) {
                ...
                String cap2_1 = "Capitulo II | A Jornada Começa !!";
                String txtCap2_1 = "Determinado(a)," + principal.nome + " busca uma tripulação que aceite aprendizes em sua\n" +
                ...
                String txtOpc1_cap2_1 = "| Rumbar | uma bando desconhecido cujo ninguém nunca ouviu falar";
                String txtOpc2_cap2_1 = "| Bellamy | Piratas infames cujo seus feitos ecoam pelos 4 mares";
                
                // Cap 2.1.1 | texto
                // Caso Rumbar

                String cap2_1_1 = "" ;
                String txtCap2_1_1 = "Como um pirata novato, você se junta a uma pequena tripulação dos\n" +
                ...
                String txt2_Cap2_1_1 = "Seu comprometimento, habilidades e lealdade ao bando eram incontestáveis.\n" +
                ...
                String txtOpc1_cap2_1_1 = "| Lutar |";
                String txtOpc2_cap2_1_1 = "| Fugir |";

                // Cap 3.1.1.1 | texto
                // Lutar               
        
                String cap3_1_1_1 = "Capitulo III | Turbulência dos Mares: A Jornada de ";

                String txtCap3_1_1_1 = "- " + principal.nome
                ...
                String txt2_cap3_1_1_1 = "Chegou o dia em que o destino da tripulação tomou um rumo trágico.\n" +
                ...
                String txt4_cap3_1_1_1 = "Finalmente, restava apenas " + principal.nome
                ...
                String cap3_1_1_2 = "Capitulo III | Hachinosu Sangue e Tesouros";

                String txtCap3_1_1_2 = "Após meses de preparação, os Piratas Rumbar finalmente chegaram à última\n" +
                ...
                String txt2_cap3_1_1_2 = "Enquanto os Piratas Rumbar resistiam bravamente, Yorki tomou uma\n" +
                ...
                String cap3_1_2 = "Capitulo III | "+principal.nome+", da Revolta à Justiça nos Mares";

                String txtCap3_1_2 = "Atraído pela promessa de poder e fama que o Capitão Bellamy representava, "
                                + principal.nome + " se\n" +
                                "juntou à tripulação\n"+
                ...
                String txt3_cap3_1_2 = "Após o confronto, Luffy se aproximou de " + principal.nome
                ...
                if(capitulo1.escolha("tentar", "desistir")){
                        ...
                        capitulo2_1.txtOpcoes(txtOpc1_cap2_1, txtOpc2_cap2_1);
                                ...
                                if(capitulo2_1.escolha("rumbar","bellamy")){
                                        ...
                                        capitulo2_1_1.soTxt(txt2_Cap2_1_1);
                                        capitulo2_1_1.txtOpcoes(txtOpc1_cap2_1_1,txtOpc2_cap2_1_1);
                                
                                        if(capitulo2_1_1.escolha("lutar", "fugir")){
                                                //Lutar 
                                                capitulo capitulo3_1_1_1 = new capitulo( cap3_1_1_1 , txtCap3_1_1_1 , principal , yorki )  ;
                                                capitulo3_1_1_1.historia();
                                                capitulo3_1_1_1.mudaBravura(20,principal);
                                                capitulo3_1_1_1.mudaBravura(20, yorki);
                                                capitulo3_1_1_1.soTxt(txt2_cap3_1_1_1);
                                                capitulo3_1_1_1.mudaBravura(-30,principal);
                                                capitulo3_1_1_1.soTxt(txt3_cap3_1_1_1);
                                                capitulo3_1_1_1.mudaBravura(-60,principal);
                                                capitulo3_1_1_1.mudaBravura(-1000, yorki);
                                                capitulo3_1_1_1.soTxt(txt4_cap3_1_1_1);
                                                capitulo3_1_1_1.mudaBravura(-1000, principal);
                                                capitulo3_1_1_1.fim();
                                                //fim
                                        }
                                                ...
                                                //Fugir
                                                capitulo capitulo3_1_1_2 = new capitulo( cap3_1_1_2 , txtCap3_1_1_2 , principal , yorki );
                                                capitulo3_1_1_2.soTxt(txtfala);
                                                capitulo3_1_1_2.mudaBravura(-20,principal);
                                                capitulo3_1_1_2.mudaBravura(-20,yorki);
                                                capitulo3_1_1_2.historia();
                                                capitulo3_1_1_2.mudaBravura(20,principal);
                                                capitulo3_1_1_2.mudaBravura(20,yorki);
                                                capitulo3_1_1_2.soTxt(txt2_cap3_1_1_2);
                                                capitulo3_1_1_2.mudaBravura(-1000,yorki);
                                                capitulo3_1_1_2.soTxt(txt3_cap3_1_1_2);
                                                capitulo3_1_1_2.mudaBravura(40,principal);
                                                capitulo3_1_1_2.soTxt(txt4_cap3_1_1_2);
                                                capitulo3_1_1_2.mudaBravura(1000,principal);
                                                capitulo3_1_1_2.fim();
                                                //fim
                                        }
                                }
                                        ...
                                        capitulo capitulo3_1_2 = new capitulo(cap3_1_2,txtCap3_1_2,principal,bellamy);
                                        capitulo3_1_2.historia();
                                        capitulo3_1_2.mudaBravura(-20,principal);
                                        capitulo3_1_2.soTxt(txt2_cap3_1_2);
                                        capitulo3_1_2.mudaBravura(-30,principal);
                                        capitulo3_1_2.mudaBravura(-100, bellamy);
                                        capitulo3_1_2.soTxt(txt3_cap3_1_2);
                                        capitulo3_1_2.mudaBravura(1000, principal);
                                        capitulo3_1_2.fim();
                                        //fim
                                }  
                        ...
                        capitulo capitulo2_2 = new capitulo(cap2_2,txtCap2_2,principal,null);
                        capitulo2_2.historia();
                        capitulo2_2.mudaBravura(-100, principal);
                        capitulo2_2.fim();
                        //fim
                }
                insira.close();
