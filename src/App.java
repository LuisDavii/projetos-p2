...
public class App {
        public static void main(String[] args) {
                ...
                String cap1txt = "Em um pequeno vilarejo no North Blue, vivia um(a) jovem chamado(a) "
                                + principal.getNome() + ".\n" +
                                ...
                                "e repetidos fracassos, " + principal.getNome()
                                + " começa a questionar seu sonho de se tornar um pirata\n"
                ...
                String txtOpc2_cap1 = "| Desistir | O sol poente lança uma sombra melancólica sobre a pequena\n" +
                                "vila onde vive " + principal.getNome() + ".";

                // Cap 2| texto
                // Tentar
                texto[] cap2Txt = new texto[1];
                String cap2 = "Capitulo II | A Jornada Começa !!";
                String cap2txt = "Determinado(a)," + principal.getNome()
                                + " busca uma tripulação que aceite aprendizes em sua\n" +
                ...
                String cap3txt = "Como um pirata novato, você se junta a uma pequena tripulação dos\n" +
                                ...
                                "\nApós dois anos navegando com a tripulação dos Piratas Rumbar, " + principal.getNome()
                                +
                ...
                String cap4txt = "- " + principal.getNome()
                ...
                String cap4txt2 = "Chegou o dia em que o destino da tripulação tomou um rumo trágico.\n" +
                                principal.getNome() + ", estava pronto para provar seu valor no campo de batalha.\n" +
                                ...
                                "perderam a vida. " + principal.getNome()
                                ...
                                "por vingança, " + principal.getNome()
                                + " percebeu que a morte de seu bando era inevitável.\n"
                                +
                                "\nCom pesar, " + principal.getNome()
                                + " olhou para os olhos de seus companheiros feridos, e a\n" +
                                "tristeza invadiu seu coração.\n" +
                                "\n- " + principal.getNome() + " ''Precisamos fugir! Não há mais esperança aqui.''";
                ...
                String cap4txt3 = "\nJuntos, eles correram para o navio destruído, desesperados por escapa\n" +
                                ...
                                "inimigos, um por um, Cap Yorki e outros companheiros de " + principal.getNome()
                ...
                String cap4txt4 = "Finalmente, restava apenas " + principal.getNome()
                                ...
                                "\nCom lágrimas em seus olhos," + principal.getNome()
                                ...
                                "\n" + principal.getNome() + " Perdeu 1000 de bravura\nSua bravura se esgotou.\n"
                                + principal.getNome() +
                ...
                String cap5txt = "" + principal.getNome()
                ...
                String cap5txt5 = "\nGolpes brutais eram desferidos. O sangue escorria dos ferimentos, Com a habilidade\n"
                                +
                                "aprimorada pela chama da vingança, " + principal.getNome()
                                ...
                                "\nCom o coração pesado pela perda de Yorki, " + principal.getNome()
                                ...
                                "\nEnquanto a chuva caía sobre a costa da última ilha, " + principal.getNome()
                                + " se levantou, olhando para o\n" +
                                "horizonte com um olhar de determinação. Ele sabia que ainda havia um tesouro a ser \n"
                                +
                                "conquistado, e os Piratas Rumbar continuariam sua jornada, agora com "
                                + principal.getNome()
                                + " como seu novo capitão.\n" + "\n" + principal.getNome() + " Ganhou 1000 de bravura\n"
                                +
                ...
                // Cap 6 | Texto
                // Bellamy
                String cap6 = "Capitulo III | " + principal.getNome() + ", da Revolta à Justiça nos Mares";
                texto[] cap6Txt = new texto[3];
                String cap6txt = "Atraído pela promessa de poder e fama que o Capitão Bellamy representava, "
                                + principal.getNome() + " se\n" +
                                "juntou à tripulação\n" +
                                "\nEnquanto navegavam pelos mares, " + principal.getNome()
                ...
                String cap6txt2 = "\nCerto dia marco e seus companheiros chegaram à ilha Jaya, cruzaram seu caminho com\n"
                                ...
                                +
                                "profundamente " + principal.getNome()
                                + ", que se viu questionando se o caminho pirata era realmente o que\n" +
                                "ele desejava seguir";
                cap6Txt[1] = new texto(cap6txt2, -30, -100);

                String cap6txt3 = "Após o confronto, Luffy se aproximou de " + principal.getNome()
                                + " com um sorriso sincero. Ele reconheceu\n" +
                                "o potencial e a determinação de " + principal.getNome()
                                + " e ofereceu a ele a oportunidade de se juntar à\n" +
                                "tripulação dos Chapéus de Palha." + principal.getNome()
                                ...
                                "como Bellamy, " + principal.getNome()
                ...
                String cap7txt = "" + principal.getNome()
                                ...
                                "\nContudo, a vida marítima não é tão romântica como " + principal.getNome()
                                + " imaginava. Enfrentando\n" +
                                "tempestades violentas e encontros com piratas cruéis, a tripulação de "
                                + principal.getNome() + "\n" +
                                "experimenta o lado mais sombrio dos mares\n" +
                                "\nDurante uma batalha contra um poderoso pirata, " + principal.getNome()
                                + " testemunha a perda trágica de\n" +
                                "um membro querido de sua família, que havia embarcado em sua própria jornada como\n" +
                                "pirata. A dor da perda é avassaladora, deixando " + principal.getNome()
                                + " profundamente abalado.\n"
                                +
                                "\nAlém disso, " + principal.getNome()
                                + " é capturado e aprisionado pela marinha que caça piratas\n" +
                                ...
                                "constantes que um pirata enfrenta, levam " + principal.getNome()
                ...
                capitulo1.setEscolhas(cap1Escolhas);
                ...
                capitulo2.setEscolhas(cap2Escolhas);
                ...
                capitulo3.setEscolhas(cap3Escolhas);
